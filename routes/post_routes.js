...
let Profile = require('../models/gems_model');
// User Model
let User = require('../models/user');

let Job = require('../models/post_jobs_model');


router.get('/getvotes_jobs',(req,res) =>{
  Job.find({},(err,jobs) => {
    if(err)
    {
      console.log(err);
    }else{
      Jobs = jobs.slice(0).reverse();
      res.send(jobs);
    }
  });
});
...
router.get('/getvotes_profile',(req,res) =>{
...
router.post('/addupvote_jobs/:id',(req,res) =>{
...
router.post('/addupvote_profile/:id',(req,res) =>{
